...
`fiscalProfile.expected(profile, period, hasIntracom, hasIntracomServices, hasD301, hasD307, hasD311)` derivă lista
...
| **validat oficial** | trece validatorul ANAF (DUKIntegrator) fără erori | `scripts/valideaza-duk.sh D300/D301/D307/D311/D394/D112/D390/D100/D205/D406 fișier.xml` |
| **necesită verificare contabilă** | corectitudinea de FOND (încadrări, deduceri, spețe) | întotdeauna — vezi §4 |

Toate ieșirile fiscale din bateria de referință, inclusiv D301, D307 și D311 în variantele lor distincte,
