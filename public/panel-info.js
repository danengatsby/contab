...
var PANEL_INFO = [
  ...
  // Documente
  ['Înregistrează un document primit', 'Workbench-ul păstrează un singur traseu vizibil: încarci PDF-ul sau poza, verifici datele extrase și postezi înregistrarea.'],
  ['Articol contabil propus', 'Previzualizarea contabilă rezultată din datele documentului. Confirmă sumele și explică eventualele corecturi înainte de postare.'],
  ['2 · Verifică și salvează', 'Câmpurile documentului emis sunt editabile. Verifici sumele și tipul, apoi salvezi — articolul contabil se generează automat, cu previzualizare.'],
  ['Extras bancar', 'Încarci CSV/MT940/CAMT.053; aplicația păstrează hash-ul, IBAN-ul și soldurile, refuză reimportul și propune punctajul pentru confirmare.'],
  ['SPV și e-Factura XML', 'Facturile electronice primite în SPV sau ca fișier XML. Importul din SPV deschide același pas de verificare ca încărcarea obișnuită.'],
