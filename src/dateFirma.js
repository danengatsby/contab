...
const CAMPURI = [
  ...
  { camp: 'regCom', eticheta: 'Numărul Registrului Comerțului',
    deCe: 'confirmă identitatea juridică a firmei pe documentele emise' },
  { camp: 'tipEntitate', eticheta: 'Forma juridică',
    deCe: 'decide dacă se aplică regulile pentru societăți sau pentru PFA' },
  { camp: 'tvaPlatitor', eticheta: 'Statutul de TVA',
    deCe: 'decide regimul TVA și declarațiile pe care firma trebuie să le pregătească' },
