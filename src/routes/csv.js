...
module.exports = function register(app, ctx) {
  ...
  app.get('/csv/vat-sales', (req, res) => {
    const vS = S(req); const vj = acc.vatJournals(vS, acc.vatPeriod(vS, req.query.period || null));
  ...
  app.get('/csv/vat-purchases', (req, res) => {
    const vP = S(req); const vj = acc.vatJournals(vP, acc.vatPeriod(vP, req.query.period || null));
