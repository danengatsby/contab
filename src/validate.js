...
const ROOTS = { d300: 'declaratie300', d301: 'declaratie301', d394: 'declaratie394', d390: 'declaratie390', d205: 'declaratie205', d112: 'D112', saft: 'AuditFile', d100: 'declaratie100', d101: 'declaratie101', intrastat: 'declaratieIntrastat' };
...
function validateDeclaration(type, xml, ctx) {
  ...
  if (['d300', 'd301', 'd394', 'd390', 'd100', 'intrastat'].includes(type)) {
